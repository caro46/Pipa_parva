...
```
[AdapterRemoval v2](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4751634/) seems to be a pretty good program to try if `scythe` does not work as well as expected.
## Jellyfish/quake
